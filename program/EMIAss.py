...
Tk.Label(main_window,text='Downpayment',bg="#f0a33c",padx=10,pady=10).grid(row=5)
#Creating Buttons
Tk.Button(main_window,text="Calculate",command=calculate,bg="light blue",fg="black",padx=10,pady=10).grid(row=7,columnspan=1)
#Tk.Button(main_window,text="Reset",command=reset,bg="light blue",fg="black",padx=10,pady=10).grid(row=8,columnspan=4)
...
Tk.Entry(main_window,textvariable=month).grid(row=4,column=1)
Tk.Entry(main_window,textvariable=downpayment).grid(row=5,column=1)


Tk.Label(main_window,text='EMI',bg="#f0a33c",padx=10,pady=10).grid(row=9,columnspan=2)
Tk.Label(main_window,textvariable=emi,bg="#f0a33c",font=('Arial',16),padx=10,pady=10).grid(row=10,columnspan=2)
Tk.Label(main_window,text='Total Interest',bg="#f0a33c",padx=10,pady=10).grid(row=11,columnspan=2)
Tk.Label(main_window,textvariable=total_interest,bg="#f0a33c",font=('Arial',16),padx=10,pady=10).grid(row=12,columnspan=2)
Tk.Label(main_window,text='Total Amount',bg="#f0a33c",padx=10,pady=10).grid(row=13,columnspan=2)
Tk.Label(main_window,textvariable=total_payment,bg="#f0a33c",font=('Arial',16),padx=10,pady=10).grid(row=14,columnspan=2)
